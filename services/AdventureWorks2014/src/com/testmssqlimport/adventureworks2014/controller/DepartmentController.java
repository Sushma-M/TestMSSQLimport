...
import com.testmssqlimport.adventureworks2014.service.DepartmentService;
...
@RestController(value = "AdventureWorks2014.DepartmentController")
@Api(value = "/AdventureWorks2014/Department", description = "Exposes APIs to work with Department resource.")
...
public class DepartmentController {
    ...
    public Department editDepartment(@PathVariable("id") short id, @RequestBody Department instance) throws EntityNotFoundException {
        LOGGER.debug("Editing Department with id: {}" , instance.getDepartmentId());
    ...
    @ApiOperation(value = "Gets the employeeDepartmentHistories instance associated with the given id.")
     public Page<EmployeeDepartmentHistory> findAssociatedemployeeDepartmentHistories(Pageable pageable, @PathVariable("id") short id){
        LOGGER.debug("Fetching all associated employeeDepartmentHistories");
        return employeeDepartmentHistoryService.findAssociatedValues(id,"department","departmentId", pageable);
   }
