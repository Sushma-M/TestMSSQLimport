...
/**
 * VemployeeDepartment generated by hbm2java
 */
@Entity
@Table(name="`vEmployeeDepartment`"
    ,schema="HumanResources"
)
@IdClass(value=VemployeeDepartmentId.class)
public class VemployeeDepartment  implements java.io.Serializable {
    ...
    public boolean equals(Object o) {
		 ...
		 if ( !(o instanceof VemployeeDepartment) )
		    return false;

		 VemployeeDepartment that = (VemployeeDepartment) o;
