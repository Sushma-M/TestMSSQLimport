 ...
 */
@Service("testdb345.Table1Service")
public class Table1ServiceImpl implements Table1Service {
    ...
    public void setWMGenericDao(WMGenericDao<Table1, Integer> wmGenericDao){
     ...
     @Transactional(readOnly = true, value = "testdb345TransactionManager")
    ...
    @Transactional(rollbackFor = EntityNotFoundException.class, value = "testdb345TransactionManager")
    @Override
